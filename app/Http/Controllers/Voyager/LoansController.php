...
class LoansController extends VoyagerBaseController
{
    ...
    public function index(Request $request)
    {
        ...
        if (strlen($dataType->model_name) != 0) {
            ...
            if ($orderBy && in_array($orderBy, $dataType->fields())) {
                ...
                foreach($dataTypeContent as $new ){

                   $loanprop =  $new->user->name;
                   $new['loanMaker']= $loanprop;
